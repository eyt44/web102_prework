...
contributionsCard.innerHTML = `${totalContributions.toLocaleString('en-US')} Contributions`;
...
const unfundedExplanation = `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length === 1 ? "1 game" : `${GAMES_JSON.length} games`}. Currently, ${numUnfundedGames === 1 ? "1 game remains unfunded." : `${numUnfundedGames} games remain unfunded.`} We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
const unfundedElement = document.createElement("p");
unfundedElement.textContent = unfundedExplanation;
